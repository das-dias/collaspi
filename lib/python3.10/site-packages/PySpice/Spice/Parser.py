...
class Element(Statement):
    ...
    def __init__(self, line):
        ...
        # detect number of positionals and explicit parameter attributions
        ...
        # Fix missing parameters in X mosfet device model declarations by reading kwarg parameters
        #if prefix_data.has_variable_number_of_pins and stop_location is not None:
        #    remaining, stop_location = self._line.split_words(stop_location, until=os.linesep)
        #    self._dict_parameters.extend(remaining)
